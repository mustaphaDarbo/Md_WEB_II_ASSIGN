...
mongoose.connect('mongodb+srv://mdarboe0708_db_user:mdarboe123@mdarboe.k6ypmim.mongodb.net/cmsDB')
  .then(async () => {
    ...
    // Create test users with correct emails
    const testUsers = [
      { fullName: 'Super Admin', email: 'admin@test.com', roleName: 'SuperAdmin' },
      { fullName: 'Manager User', email: 'manager@test.com', roleName: 'Manager' },
      { fullName: 'Contributor User', email: 'contributor@test.com', roleName: 'Contributor' },
      { fullName: 'Viewer User', email: 'viewer@test.com', roleName: 'Viewer' }
    ];
