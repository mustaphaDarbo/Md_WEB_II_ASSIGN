...
mongoose.connect('mongodb+srv://mdarboe0708_db_user:mdarboe123@mdarboe.k6ypmim.mongodb.net/cmsDB')
  .then(async () => {
    ...
    // Delete old test.com users
    const oldEmails = ['admin@test.com', 'manager@test.com', 'contributor@test.com', 'viewer@test.com'];
    ...
    // Create new test users with different domains
    const testUsers = [
      { fullName: 'Super Admin', email: 'admin@gmail.com', roleName: 'SuperAdmin' },
      { fullName: 'Manager User', email: 'manager@yahoo.com', roleName: 'Manager' },
      { fullName: 'Contributor User', email: 'contributor@hotmail.com', roleName: 'Contributor' },
      { fullName: 'Viewer User', email: 'viewer@outlook.com', roleName: 'Viewer' }
    ];
    ...
    console.log('manager@yahoo.com / 123456 (Manager)');
    console.log('contributor@hotmail.com / 123456 (Contributor)');
    console.log('viewer@outlook.com / 123456 (Viewer)');
